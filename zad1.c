...
char *domains[] = {"gmail.com", "wp.pl", "poczta.onet.pl", "buziaczek.pl", "sigma.ug.edu.pl", "microsoft.com"};
char *users[] = {"jkowalski", "nieja", "gosiaczek69", "spamer", "rumcjas", "johny.bravo", "bill.gates", "cj"};
